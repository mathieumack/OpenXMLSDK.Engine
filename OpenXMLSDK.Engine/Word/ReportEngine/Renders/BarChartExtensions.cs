        ...
        public static void ManageBarChart(BarModel chartModel, PlotArea plotArea, UInt32Value categoryAxisId, UInt32Value valuesAxisId, ref uint i, bool addAxes = true)
        {
            ...
            if (addAxes)
            {
                ...
                var valueAxis = new ValueAxis(
                    ...
                    new MajorTickMark() { Val = TickMarkValues.None },
                    new MinorTickMark() { Val = TickMarkValues.None },
                    new TickLabelPosition() { Val = chartModel.ValuesAxisModel.TickLabelPositions.HasValue ? new EnumValue<TickLabelPositionValues>((TickLabelPositionValues)(int)chartModel.ValuesAxisModel.TickLabelPositions) : new EnumValue<TickLabelPositionValues>(TickLabelPositionValues.NextTo) },
