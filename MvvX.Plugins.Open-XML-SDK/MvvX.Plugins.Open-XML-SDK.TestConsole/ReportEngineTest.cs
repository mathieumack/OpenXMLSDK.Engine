...
namespace MvvX.Open_XML_SDK.TestConsole
{
    public static class ReportEngineTest
    {
        ...
        private static ContextModel GetContext()
        {
            ...
            {
                BarChartContent = new Plugins.OpenXMLSDK.Word.ReportEngine.BatchModels.Charts.BarModel()
                {
                            ...
                            new Cell()
                            {
                                ...
                                ChildElements = new List<BaseElement>()
                                {
                                    ...
                                    new Image()
                                    {
                                        ...
                                        ImagePartType = Plugins.OpenXMLSDK.Packaging.ImagePartType.Jpeg
                                    },
                    ...
                    Cells = new List<Cell>()
    {
        ...
        new Cell()
        {
            ...
            {
                ChildElements = new List<BaseElement>() {
                    new Plugins.OpenXMLSDK.Word.ReportEngine.Models.Charts.BarModel()
                    {
                        Title = "Graph test",
                        ShowTitle = true,
                        FontSize = "23",
