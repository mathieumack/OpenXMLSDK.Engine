...
{
    public static class WordReportSample
    {
        public static void ReportEngineTest()
        {
        ...
        public static void GenerateLotsOfThings(Document doc)
        {
            var page1 = new Page();
        ...
        /// </summary>
        /// <param name="doc"></param>
        public static void GenerateParagraphsWithStyle(Document doc)
        {
            var page = new Page
            {
        ...
        /// </summary>
        /// <param name="doc"></param>
        public static void GenerateForeachPage(Document doc)
        {
        ...
        /// </summary>
        /// <param name="doc"></param>
        public static void GenerateTextWithHeritage(Document doc)
        {
            var page = new Page();
        ...
        /// </summary>
        /// <param name="doc"></param>
        public static void GenerateTableOfContent(Document doc)
        {
            var page = new Page();
        ...
        /// </summary>
        /// <param name="doc"></param>
        public static void GenerateUniformGrid(Document doc)
        {
            var page = new Page();
        ...
        /// </summary>
        /// <param name="doc"></param>
        public static void GenerateTable(Document doc)
        {
            var page = new Page();
        ...
        /// </summary>
        /// <param name="doc"></param>
        public static void GenerateGraph(Document doc)
        {
            var page = new Page();
        ...
        /// </summary>
        /// <param name="doc"></param>
        public static void GenerateTableWithFusionedCells(Document doc)
        {
            var page = new Page();
        ...
        /// </summary>
        /// <param name="doc"></param>
        public static void GenerateTextWithEmptyLine(Document doc)
        {
            var page = new Page();
        ...
        /// </summary>
        /// <param name="doc"></param>
        public static void GenerateStyles(Document doc)
        {
        ...
        /// </summary>
        /// <param name="doc"></param>
        public static void GenerateHeaderAndFooter(Document doc)
        {
            // Header
