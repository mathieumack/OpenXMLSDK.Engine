...
//        public static void InsertGraphBarGroupingToBookmark(this WordManager eoWord, string bookmark, ChartModel chartModel)
//        {
//            if(string.IsNullOrWhiteSpace(bookmark))
//                throw new ArgumentNullException("bookmark must not be null or white space");
...
//            var graph = eoWord.CreateBarGroupingGraph(chartModel);
//            eoWord.SetOnBookmark(bookmark, graph);
//        }
...
//        /// <exception cref="ChartModelException">Model de graphique invalide</exception>
//        /// <returns></returns>
//        public static PlatformRun CreateBarGroupingGraph(this WordManager eoWord, ChartModel chartModel)
//        {
//            if(chartModel.Categories == null)
//                throw new ArgumentNullException("categories of chartModel must not be null");
//            if(chartModel.Series == null)
...
//            ChartPart chartPart = eoWord.AddNewPart<ChartPart>();
...
//                {
//                    numLit.NumberingCache.AppendChild<dc.NumericPoint>(new dc.NumericPoint() { Index = p, NumericValue = new dc.NumericValue(value) });
//                    p++;
//                }
//                i++;
//            }
...
//            if (chartModel.SpaceBetweenLineCategorie.HasValue)
//                barChart.Append(new dc.GapWidth() { Val = (UInt16)chartModel.SpaceBetweenLineCategorie.Value });
//            else
...
//            }),
//                new dc.Delete() { Val = chartModel.DeleteAxeCategorie },
...
//            string relationshipId = eoWord.GetIdOfPart(chartPart);
...
//            var graph = eoWord.CreateDoughnutGraph(chartModel);
//            eoWord.SetOnBookmark(bookmark, graph);
//        }
...
//        /// </summary>
//        /// <param name="eoWord"></param>
//        /// <param name="chartModel"></param>
//        /// <returns></returns>
//        public static PlatformRun CreateDoughnutGraph(this WordManager eoWord, ChartModel chartModel)
//        {
//            if(chartModel.Categories == null)
//                throw new ArgumentNullException("categories of chartModel must not be null");
//            if(chartModel.Series == null)
...
//                    numLit.NumberingCache.AppendChild<dc.NumericPoint>(new dc.NumericPoint() { Index = p, NumericValue = new dc.NumericValue(chartModel.Series[i].Values[numCateg]) });
