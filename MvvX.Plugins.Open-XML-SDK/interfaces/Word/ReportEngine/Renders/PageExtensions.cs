    ...
    public static class PageExtensions
    {
        public static void Render(this Page page, OpenXmlElement wdDoc, ContextModel context, MainDocumentPart mainDocumentPart, IFormatProvider formatProvider)
        {
            ...
            var pageSize = new PageSize()
            {
                ...
                Width = UInt32Value.FromUInt32(page.PageOrientation == OpenXMLSDK.Engine.Word.PageOrientationValues.Landscape ? (uint)16839 : 11907),
                Height = UInt32Value.FromUInt32(page.PageOrientation == OpenXMLSDK.Engine.Word.PageOrientationValues.Landscape ? (uint)11907 : 16839)
            };
